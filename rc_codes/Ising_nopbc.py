...
for (ind_g,g) in enumerate(gammaList):
    ...
    eqSteps = 2**20     #  number of MC sweeps for equilibration
    ...
    np.savetxt('/home1/yl244/data/Ising_ext_complete_0/E_trace_p='+str(p)+'g='+str(g.round(6))+'.out', EList)
    np.savetxt('/home1/yl244/data/Ising_ext_complete_0/M_trace_p='+str(p)+'g='+str(g.round(6))+'.out', MList)
    np.savetxt('/home1/yl244/data/Ising_ext_complete_0/C_trace_p='+str(p)+'g='+str(g.round(6))+'.out', CList)
    np.savetxt('/home1/yl244/data/Ising_ext_complete_0/X_trace_p='+str(p)+'g='+str(g.round(6))+'.out', XList)
    ...
    np.savetxt('/home1/yl244/data/Ising_ext_complete_0/E_p'+str(p)+'.out',E)
    np.savetxt('/home1/yl244/data/Ising_ext_complete_0/M_p'+str(p)+'.out',M)
    np.savetxt('/home1/yl244/data/Ising_ext_complete_0/C_p'+str(p)+'.out',C)
    np.savetxt('/home1/yl244/data/Ising_ext_complete_0/X_p'+str(p)+'.out',X)
