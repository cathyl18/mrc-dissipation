...
path0 = 'data/RC_TN/' + name
os.makedirs(path0,exist_ok=True)

path1 = 'data/RC_TN/' + name + '/N=' + str(Nqubit)
os.makedirs(path1,exist_ok=True)

homepath = 'data/RC_TN/' + name + '/N=' + str(Nqubit)+ '/r=' + r_name +  'p=' + p_name
os.makedirs(homepath,exist_ok=True)
...
#         eigpartialT[i]={}
        ...
        #eig1prof[i], eig2prof[i], eigtotprof[i], eigpartialT[i] = calcEigs(rho, Nqubit, [n for n in range(Nqubit//2)])
