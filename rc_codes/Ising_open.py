...
def mcmove(config, Jd, Jh, J123, h):
    ...
    for i in range(N):
        for j in range(N):
                ...
                a = np.random.randint(0, N-1) # rows #so a will never be N-1, i.e. the last row
                b = np.random.randint(0, N) # columns
                s =  config[a, b]
...
np.savetxt('/home1/yl244/data/Ising_open/E_p='+str(p)+'g='+str(g.round(6))+'.out', np.array([E]) )
np.savetxt('/home1/yl244/data/Ising_open/M_p='+str(p)+'g='+str(g.round(6))+'.out', np.array([M]) )
np.savetxt('/home1/yl244/data/Ising_open/C_p='+str(p)+'g='+str(g.round(6))+'.out', np.array([C]) )
np.savetxt('/home1/yl244/data/Ising_open/X_p='+str(p)+'g='+str(g.round(6))+'.out', np.array([X]) )
