...
np.savetxt('/home1/yl244/data/Ising_up/E_p='+str(p)+'g='+str(g.round(6))+'.out', np.array([E]) )
np.savetxt('/home1/yl244/data/Ising_up/M_p='+str(p)+'g='+str(g.round(6))+'.out', np.array([M]) )
np.savetxt('/home1/yl244/data/Ising_up/C_p='+str(p)+'g='+str(g.round(6))+'.out', np.array([C]) )
np.savetxt('/home1/yl244/data/Ising_up/X_p='+str(p)+'g='+str(g.round(6))+'.out', np.array([X]) )
