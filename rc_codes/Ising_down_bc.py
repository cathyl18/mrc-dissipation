...
np.savetxt('/home1/yl244/data/Ising_down/E_p='+str(p)+'g='+str(g.round(6))+'.out', np.array([E]) )
np.savetxt('/home1/yl244/data/Ising_down/M_p='+str(p)+'g='+str(g.round(6))+'.out', np.array([M]) )
np.savetxt('/home1/yl244/data/Ising_down/C_p='+str(p)+'g='+str(g.round(6))+'.out', np.array([C]) )
np.savetxt('/home1/yl244/data/Ising_down/X_p='+str(p)+'g='+str(g.round(6))+'.out', np.array([X]) )
