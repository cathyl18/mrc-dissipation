...
# Autocoorelation stuff
t_wList = np.array([2**4,2**6,2**8,2**10,2**12,2**14,2**16,2**18])-1
...
#print('alltime=', t_wList[1] + deltaT, flush=True)
...
np.savetxt('/home1/yl244/data/Ising_final/E_p='+str(p)+'g='+str(g.round(6))+'.out', np.array([E]) )
np.savetxt('/home1/yl244/data/Ising_final/M_p='+str(p)+'g='+str(g.round(6))+'.out', np.array([M]) )
np.savetxt('/home1/yl244/data/Ising_final/C_p='+str(p)+'g='+str(g.round(6))+'.out', np.array([C]) )
np.savetxt('/home1/yl244/data/Ising_final/X_p='+str(p)+'g='+str(g.round(6))+'.out', np.array([X]) )

# print('data saved, time cost = ', time.time()-startTime, flush=True)

np.savetxt('/home1/yl244/data/Ising_autoC_f/p='+str(p)+'g='+str(g)+ 'autoC' + str(t_wList[0]) + 'ind0.out', allC0)
np.savetxt('/home1/yl244/data/Ising_autoC_f/p='+str(p)+'g='+str(g)+ 'autoC' + str(t_wList[1]) + 'ind0.out', allC1)
np.savetxt('/home1/yl244/data/Ising_autoC_f/p='+str(p)+'g='+str(g)+ 'autoC' + str(t_wList[2]) + 'ind0.out', allC2)
np.savetxt('/home1/yl244/data/Ising_autoC_f/p='+str(p)+'g='+str(g)+ 'autoC' + str(t_wList[4]) + 'ind0.out', allC4)
np.savetxt('/home1/yl244/data/Ising_autoC_f/p='+str(p)+'g='+str(g)+ 'autoC' + str(t_wList[5]) + 'ind0.out', allC5)
np.savetxt('/home1/yl244/data/Ising_autoC_f/p='+str(p)+'g='+str(g)+ 'autoC' + str(t_wList[6]) + 'ind0.out', allC6)
np.savetxt('/home1/yl244/data/Ising_autoC_f/p='+str(p)+'g='+str(g)+ 'autoC' + str(t_wList[7]) + 'ind0.out', allC7)
